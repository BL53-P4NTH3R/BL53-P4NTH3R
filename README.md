...
- **Computer Vision:** OpenCV, Torchvision, Image Processing, CNNs, Transfer Learning  
- **Data Visualization:** Matplotlib, Seaborn  
- **MLOps & Deployment:** FastAPI, REST APIs, Model Inference Pipelines  
- **Tools & Workflow:** Git, GitHub, VS Code, Jupyter Notebook  
- **Web & App Interfaces:** Streamlit, Nestjs  
